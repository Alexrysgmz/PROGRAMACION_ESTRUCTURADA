"""
  Una función es un conjunto de instrucciones agrupadas bajo un nombre en particular como
  un programa mas pequeño que cumple una funcion especifica. La funcion se puede reutulizar con 
  el simple hecho de invocarla es decir mandarla llamar 
...
nombre=input("Nombre: ")
telefono=input("Telefono: ")
nombre,telefono=solicitarDatos4()
print(f"\n\t\tAgenda Telefonica: \n\tNombre:{nombre} \n\tTelefono: {telefono}")
