...
La lista es una coleccion ordenada y modificable. Permite miembors duplicados
...
print(f"El valor de Canada lo encontró en la posicion: {posicion}")
...
#Crear a partir de las listas de numeros 1 y 2 un resultante y mostrar el contenido ordenado descendientemente
os.system('cls')
